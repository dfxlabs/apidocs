...
def get_depth(self, symbol: str, n_layers: int) -> dict:
	...
	rsp = self._req('GET', path, params, to_sign=False)
...
``` java
{
	...
	"data": [{
		...
		"baseToken": "BTC",
		"quoteToken": "USD",
		"quoteIncrement": "0.01", // The smallest increment for the quote currency is 0.01 USD
		"quoteMinSize": "5", // The minimum size for a quote order is 5 USD.
		"baseIncrement": "0.00001", // The smallest increment for the base currency is 0.00001 BTC.
		"baseMinSize": "0.00001", // The minimum size for a base order is 0.00001 BTC.
		"priceIncrement": "0.01", // The smallest increment for the price is 0.01 USD.
		"enableTrading": true, 
		"priceLimitRate": "0.1" // The max price change is 10%.
	}, {
		"symbol": "ETH-USD",
		"baseToken": "ETH",
		"quoteToken": "USD",
