...
``` java
{
	...
	"data": [{
		...
		"baseToken": "BTC",
		"quoteToken": "USD",
		"quoteSizeIncrement": "0.01", // The smallest increment in order size in unit of quote asset
		"quoteMinSize": "5", // The smallest amount for an order in unit of quote asset
		"baseIncrement": "0.00001", // The smallest increment in order size in unit of base asset
		"baseMinSize": "0.00001", // The smallest amount for an order in unit of base asset
