...
**What are 'Api Key' and 'Public Key'**

Api key is the private key generated using the ed25519 algorithm.
Public key is generated from your Api key in your device locally.
Api key is kept by you. DFX will never ask you for it at any time. It is the identity assigned to you after you upload the public key to dfx.

You can create an Api key for your own account. If you need to replace an Api key, you must first delete the old one before creating a new one in the site.

**How do you generate public and private keys? If you have any questions about generating private and public keys, you can refer to the specific steps at the bottom of the article in detail. [please refer Here.](https://github.com/dfxlabs/dfxlabs.github.io/edit/main/docs/2.%20Api%20Key.md#generating-ed25519-public-and-private-keys-using-command-line-on-windows-and-mac)**
